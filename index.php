...
//                    var datumHeute = new Date();
                    ...
                    time1 = str.match(regexScore);
                    time = time1[0];
                    var firstScore = time[0] + time[1];
                    var firstScoreInt = parseInt(firstScore);
                    var secondScore = time[3] +time[4];
                    var secondScoreInt = parseInt(secondScore);
                    var stylecolor1, stylecolor2;
                    ...
                    time = '<p style="color:' + stylecolor1 + ';float:left;">' + firstScore + '<p style="float:left;"> : </p>' + '</p>' + '<p style="color:' + stylecolor2 + ';">' + secondScore +'</p>';
                    color = "rgb(140,140,140)";
                    status = ".playedMatches";
                ...
                $(status).append('<div class="matchHead" id="' + k + '" style="border-color:' + color + ';">' + ' <span style="margin-right:50px;float:left;"> ' + date + '</span>' + " " + ' <span> ' + time + '</span>' + " " + '<div style="text-align:center;font-size: 24px;float:none;">' + team1 + ' vs ' + team2 + '</div></div>');
